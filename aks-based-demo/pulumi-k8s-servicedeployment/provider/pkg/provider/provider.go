...
func construct(ctx *pulumi.Context, typ, name string, inputs provider.ConstructInputs,
	...
	case "k8s-servicedeployment:index:ServiceDeployment":
		return constructServiceDeployment(ctx, name, inputs, options)
	default:
...
func constructServiceDeployment(ctx *pulumi.Context, name string, inputs provider.ConstructInputs,
	options pulumi.ResourceOption) (*provider.ConstructResult, error) {
	...
	staticPage, err := NewServiceDeployment(ctx, name, args, options)
	if err != nil {
