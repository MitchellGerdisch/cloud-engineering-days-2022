...
namespace Pulumi.K8sServiceDeployment
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.K8sServiceDeployment.version.txt");
    ...
    internal sealed class K8sServiceDeploymentResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public K8sServiceDeploymentResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
